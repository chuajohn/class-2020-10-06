...
```{r}
read.csv("data_538/election-forecasts-2020/presidential_ev_probabilities_2020.csv") %>%
  ggplot(mapping = aes(x = total_ev, y = evprob_chal)) +
  geom_col(fill = "dodgerblue") +
  labs(title = "Biden's Projected Vote Counts", y = "Probability (%)", x = "Total Number of Electoral Votes (#)") +
  theme_economist() + 
  geom_vline(xintercept = 270) +
    annotate("text", x = 210, y = 0.023, label = "Victory threshold")
```
...
All question marks. Election hasn't happened yet. 
